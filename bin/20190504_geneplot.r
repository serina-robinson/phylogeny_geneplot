# Install packages
pacman::p_load("tidyverse", "scales", "genoPlotR", "ggsci", "readxl", "janitor", "RColorBrewer","rentrez","ggthemes","ggplot2","Biostrings","data.table","ape","phangorn")
...
pal <- c(colorRampPalette(colors=brewer.pal(8, "Set1"))(nrow(pfams)-1), "black")
...
list_reorder <- c("Xanthomonas campestris pv. campestris str. ATCC 33913",
              "Luteimonas tolerans UM1", "Mobilicoccus massiliensis SIT2", "Granulosicoccus antarcticus IMCC3135",
              "Actinoplanes atraurantiacus CGMCC 4.6857")
